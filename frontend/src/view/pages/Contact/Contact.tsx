...
export class Contact extends Component {
    render() {
        return (
            <>
                <section className="mb-32 sm:mt-6 lg:mt-8 mt-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div id="map" className="relative h-[300px] overflow-hidden bg-cover bg-[50%] bg-no-repeat">
                        {}
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15835.219788646487!2d80.21700203689959!3d6.035174636109052!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae35c23e98ba6e9%3A0x6e37bd689a12a6f8!2sGalle%2C%20Sri%20Lanka!5e0!3m2!1sen!2sus!4v1619524992238!5m2!1sen!2sus"
                                        ...
                                        <div
                                            ...
                                            <div className="flex items-start">
                                                <div className="shrink-0">
                                                    <div
                                                        className="inline-block rounded-md bg-sky-200 p-4 text-primary">
